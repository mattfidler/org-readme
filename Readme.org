...
* History
 ...
 - 12-Sep-2012 ::  Bug fix to eliminate duplicate headers in Readme.org and emacswiki ()
 - 12-Sep-2012 ::  Bug fix when org todo faces are not set. ()
 - 12-Sep-2012 ::  Added bug fix when =org-todo-keyword-faces= is undefined. ()
